...
function buildIWContent(place) {
  ...
  /*
  if (place.formatted_opening_hours) {
    document.getElementById('iw-hours-mon-row').style.display = '';
    document.getElementById('iw-hours-mon').textContent =
      place.opening_hours.weekday_text[0]
  }
  else {
    document.getElementById('iw-hours-mon-row').style.display = 'none';
  }

  if (place.formatted_phone_number) {
    document.getElementById('iw-hours-tue-row').style.display = '';
    document.getElementById('iw-hours-tue').textContent =
      place.opening_hours.weekday_text[1];
  }
  else {
    document.getElementById('iw-hours-tue-row').style.display = 'none';
  }

    if (place.formatted_phone_number) {
    document.getElementById('iw-hours-wed-row').style.display = '';
    document.getElementById('iw-hours-wed').textContent =
      place.opening_hours.weekday_text[2];
  }
  else {
    document.getElementById('iw-hours-wed-row').style.display = 'none';
  }
  
    if (place.formatted_phone_number) {
    document.getElementById('iw-hours-thr-row').style.display = '';
    document.getElementById('iw-hours-thr').textContent =
      place.opening_hours.weekday_text[3];
  }
  else {
    document.getElementById('iw-hours-thr-row').style.display = 'none';
  }
  
      if (place.formatted_phone_number) {
    document.getElementById('iw-hours-fr-row').style.display = '';
    document.getElementById('iw-hours-fr').textContent =
      place.opening_hours.weekday_text[4];
  }
  else {
    document.getElementById('iw-hours-fr-row').style.display = 'none';
  }
  
        if (place.formatted_phone_number) {
    document.getElementById('iw-hours-sat-row').style.display = '';
    document.getElementById('iw-hours-sat').textContent =
      place.opening_hours.weekday_text[5];
  }
  else {
    document.getElementById('iw-hours-sat-row').style.display = 'none';
  }
  
        if (place.formatted_phone_number) {
    document.getElementById('iw-hours-sun-row').style.display = '';
    document.getElementById('iw-hours-sun').textContent =
      place.opening_hours.weekday_text[6];
  }
  else {
    document.getElementById('iw-hours-sun-row').style.display = 'none';
  }

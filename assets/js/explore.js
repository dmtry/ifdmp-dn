...
function buildIWContent(place) {
  ...
  if (place.formatted_phone_number) {
    ...
    if (place.formatted_phone_number) {
    document.getElementById('iw-hours-m-row').style.display = '';
    document.getElementById('iw-hours-m').textContent =
      place.opening_hours.weekday_text[0]
  }
  else {
    document.getElementById('iw-hours-m-row').style.display = 'none';
  }
  
      if (place.formatted_phone_number) {
    document.getElementById('iw-hours-t-row').style.display = '';
    document.getElementById('iw-hours-t').textContent =
      place.opening_hours.weekday_text[1];
  }
  else {
    document.getElementById('iw-hours-t-row').style.display = 'none';
  }
